...
resource "aws_security_group_rule" "sg_lambda_to_rds_ingress_rule" {
  security_group_id        = aws_security_group.sg-rds.id
  type                     = "ingress"
  from_port                = 3306
  to_port                  = 3306
  protocol                 = "tcp"
  source_security_group_id = var.lambda_sg
  description              = "lambda-to-rds"
}

# resource "aws_security_group_rule" "sg_lambda_to_db_ingress_rule" {
#   security_group_id        = aws_security_group.sg-rds.id
#   type                     = "ingress"
#   from_port                = 3306
#   to_port                  = 3306
#   protocol                 = "tcp"
#   source_security_group_id = var.signup_lambda_sg
#   description              = "lambda-to-rds"
# }
